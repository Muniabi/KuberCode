                ...
                >
                    <CardHeader className="relative pb-0">
                        <div className="absolute top-4 right-4">
                            <div className="w-20 h-6 bg-zinc-200 dark:bg-zinc-700 rounded-full animate-pulse" />
                        </div>
                        <div className="w-24 h-24 rounded-2xl bg-zinc-200 dark:bg-zinc-700 mb-4 animate-pulse" />
                        ...
                        <div className="flex gap-2 mt-2">
                            {[1, 2, 3].map((i) => (
                                <div
                                    key={i}
                                    className="w-8 h-8 rounded-full bg-zinc-200 dark:bg-zinc-700 animate-pulse"
                                />
                            ))}
                        </div>
                    </CardHeader>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex flex-wrap gap-2">
                                {[1, 2, 3, 4].map((i) => (
                                    <div
                                        key={i}
                                        className="h-6 w-16 bg-zinc-200 dark:bg-zinc-700 rounded animate-pulse"
                                    />
                                ))}
                            </div>
                            <div className="grid grid-cols-3 gap-4">
                                {[1, 2, 3].map((i) => (
                                    <div
                                        key={i}
                                        className="flex flex-col items-center p-2 rounded-xl bg-zinc-200 dark:bg-zinc-700 animate-pulse"
                                    >
