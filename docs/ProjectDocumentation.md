...
<div align="center">
  ...
  <img src="https://img.shields.io/badge/Tailwind-3.0.0-38B2AC?style=for-the-badge&logo=tailwind-css" alt="Tailwind">
</div>
...
6. [Система авторизации](#система-авторизации-и-аутентификации)
7. [Работа с курсами](#работа-с-курсами)
8. [Компоненты UI](#компоненты-ui-и-стилизация)
9. [API и интеграции](#api-и-интеграции)
10. [Развертывание](#развертывание-и-мониторинг)
